...
import com.awe.awesome.service.model.FooModel;
import com.awe.awesome.service.model.FooSoap;
...
public class FooModelImpl extends BaseModelImpl<Foo> implements FooModel {
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.awe.awesome.service.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.awe.awesome.service.model.Foo"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.awe.awesome.service.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.awe.awesome.service.model.Foo"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.awe.awesome.service.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.awe.awesome.service.model.Foo"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.awe.awesome.service.service.util.ServiceProps.get(
				"lock.expiration.time.com.awe.awesome.service.model.Foo"));
	...
	public String toXmlString() {
		...
		sb.append("com.awe.awesome.service.model.Foo");
